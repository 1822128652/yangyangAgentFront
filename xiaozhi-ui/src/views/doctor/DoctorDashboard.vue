...
.background-layer {
  ...
  z-index: -1;
  transform: scale(1.05); /* 防止模糊边缘露出空白 */
}

/* 左侧菜单容器 */
.aside-container {
  background-color: rgba(15, 23, 42, 0.85); /* 添加透明度 */
  height: 100vh;
  display: flex;
...
.system-title {
  ...
  border-bottom: 1px solid rgba(51, 65, 85, 0.5); /* 调整透明度 */
  margin-bottom: 10px;
  text-align: center;
}
...
.el-menu-item {
  ...
  background-color: rgba(15, 23, 42, 0.5); /* 添加半透明背景 */
}
...
.main-content {
  padding: 25px;
  background-color: rgba(248, 250, 252, 0.85); /* 添加透明度 */
  overflow-y: auto;
